...
/**
 * Created by MTPC-133 on 12/12/2017.
 */
...
//            }
    ...
    public void setItemsTextGravity(Enums.GRAVITY gravity) {
        this.mItemsTextGravity = CommonUtils.getGravity(gravity);
        if (mAdapter != null) {
            mAdapter.setItemsTextGravity(this.mItemsTextGravity);
        }
    }

    public void setItemsTextStyle(Enums.FONT_STYLE mItemsTextStyle) {
        this.mItemsTextStyle = CommonUtils.getTextStyle(mItemsTextStyle);
        if (mAdapter != null) {
            mAdapter.setItemsTextStyle(this.mItemsTextStyle);
        }
    }

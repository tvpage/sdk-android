...
//    private String mTitleTextVisibility = "1";
  ...
  /*Item Image OverLay Style Variables End*/
    ...
    /**
     * Set video options attribute set
     *
     * @param typedArray
     */
    ...
    private void setProductCTATextStyle(TypedArray typedArray) {
        ...
        String text = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_product_cta_text);
        ...
        float mProductCTATextSize = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_modal_product_cta_text_size,
        ...
        String gravity = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_product_cta_text_gravity);
        if (CommonUtils.isValidString(gravity))
            mProductCTAGravity = gravity;

        String textStyle = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_product_cta_text_style);
        if (CommonUtils.isValidString(textStyle))
            mProductCTAStyle = textStyle;

        String fontTypeFace = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_product_cta_text_typeface);
        if (CommonUtils.isValidString(fontTypeFace))
            mProductCTATypeFace = fontTypeFace;

        String mProductCTATextTransformation = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_product_cta_text_transformation);
    ...
    /**
     * Set product price text attribute set
     *
     * @param typedArray
     */
    private void setProductPriceTextStyle(TypedArray typedArray) {
        ...
        float mProductPriceTextSize = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_modal_product_price_text_size,
        ...
        this.mProductPriceTextSize = CommonUtils.getValidFloat(mProductPriceTextSize,
                getResources().getDimension(R.dimen.default_modal_product_price_size));
        String gravity = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_product_price_text_gravity);
        if (CommonUtils.isValidString(gravity))
            mProductPriceGravity = gravity;

        String textStyle = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_product_price_text_style);
        if (CommonUtils.isValidString(textStyle))
            mProductPriceStyle = textStyle;

        String fontTypeFace = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_product_price_text_typeface);
        if (CommonUtils.isValidString(fontTypeFace))
            mProductPriceTypeFace = fontTypeFace;
    }

    /**
     * Set product popup style attribute set
     *
     * @param typedArray
     */
    private void setProductPopupStyle(TypedArray typedArray) {
        ...
        float width = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_product_popup_width,
                getResources().getDimension(R.dimen.default_product_popup_width));
        if (width != 0.0)
            mProductPopupWidth = width;

        mProductShadowColor = typedArray.getColor(R.styleable.TvPageVideoWidget_tvpw_product_popup_shadow_color,
                getResources().getColor(R.color.white));

        String mModalShadowVisibility = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_product_popup_shadow_visibility);
    ...
    private void setCloseIconStyle(TypedArray typedArray) {
        ...
        mCloseIconHeight = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_close_icon_height,
                getResources().getDimension(R.dimen.default_modal_close_icon_width_height));

        mCloseIconWidth = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_close_icon_width,
                getResources().getDimension(R.dimen.default_modal_close_icon_width_height));

        mCloseIconPadding = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_close_icon_padding,
    ...
    private void setProductTitleTextStyle(TypedArray typedArray) {
        ...
        float mProductTitleTextSize = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_modal_product_title_text_size,
        ...
        String gravity = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_product_title_text_gravity);
        if (CommonUtils.isValidString(gravity))
            mProductTitleGravity = gravity;

        String textStyle = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_product_title_text_style);
        if (CommonUtils.isValidString(textStyle))
            mProductTitleStyle = textStyle;

        String fontTypeFace = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_product_title_text_typeface);
        if (CommonUtils.isValidString(fontTypeFace))
            mProductTitleTypeFace = fontTypeFace;
    }

    /**
     * Set modal title attribute set
     */
    private void setModalTitleTextStyle(TypedArray typedArray) {
        ...
        float mModalTitleTextSize = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_modal_title_text_size,
        ...
        String gravity = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_title_text_position);
        if (CommonUtils.isValidString(gravity))
            mModalTitleGravity = gravity;

        String textStyle = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_title_text_style);
        if (CommonUtils.isValidString(textStyle))
            mModalTitleStyle = textStyle;

        String fontTypeFace = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_title_text_typeface);
        if (CommonUtils.isValidString(fontTypeFace))
    ...
    /**
     * Set modal background attribute set
     */
    private void setModalBackGroundStyle(TypedArray typedArray) {

        mModalBackGroundColor = typedArray.getColor(R.styleable.TvPageVideoWidget_tvpw_modal_background_color,
                getResources().getColor(R.color.white));

        mModalShadowColor = typedArray.getColor(R.styleable.TvPageVideoWidget_tvpw_modal_shadow_color,
                getResources().getColor(R.color.default_title_text_color));

        mModalBorderColor = typedArray.getColor(R.styleable.TvPageVideoWidget_tvpw_modal_border_color,
                getResources().getColor(R.color.default_title_text_color));

        mModalBodyPadding = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_modal_body_padding,
                getResources().getDimension(R.dimen.default_items_title_padding));

        mModalBorderWidth = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_modal_border_width,
                getResources().getDimension(R.dimen.default_items_title_padding));

        String mModalShadowVisibility = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_modal_shadow_visibility);
    ...
    private void setItemsTextStyleAttribute(TypedArray typedArray) {
        ...
        mItemsTextBackgroundColor = typedArray.getColor(R.styleable.TvPageVideoWidget_tvpw_items_text_background_color,
                getResources().getColor(R.color.white));

        mItemsTextColor = typedArray.getColor(R.styleable.TvPageVideoWidget_tvpw_items_text_color,
                getResources().getColor(R.color.default_title_text_color));


        String gravity = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_items_text_gravity);
        if (CommonUtils.isValidString(gravity))
            mItemsTextGravity = gravity;

        String textStyle = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_items_text_style);
        if (CommonUtils.isValidString(textStyle))
            mItemsTextStyle = textStyle;

        String fontTypeFace = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_items_title_font_path);
        if (CommonUtils.isValidString(fontTypeFace))
            mItemsTextTypeFace = fontTypeFace;

        mItemsTextPadding = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_items_text_padding,
                getResources().getDimension(R.dimen.default_items_title_padding));

        float textSize = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_items_text_size,
    ...
    /**
     * Set items per page and per row attribute set
     *
     * @param typedArray
     */
    private void setItemsPerPageAndRowAttributeSet(TypedArray typedArray) {
        int itemPerPage = typedArray.getInt(R.styleable.TvPageVideoWidget_tvpw_items_per_page,
                mItemsPerPage);
        if (itemPerPage != 0 && itemPerPage != mItemsPerPage) {
            mItemsPerPage = itemPerPage;
        }

        int itemPerRow = typedArray.getInt(R.styleable.TvPageVideoWidget_tvpw_items_per_row,
                mItemsPerRow);
    ...
    /**
     * Set load more button attribute set
     */
    private void setLoadMoreButtonAttributeSet(TypedArray typedArray) {
        String titleText = (String) typedArray.getText(R.styleable.TvPageVideoWidget_tvpw_load_more_button_text);
        if (CommonUtils.isValidString(titleText))
            mLoadMoreText = titleText;

        mLoadMoreTextColor = typedArray.getColor(R.styleable.TvPageVideoWidget_tvpw_load_more_button_text_color,
                getResources().getColor(R.color.white));

        mLoadMoreBackgroundColor = typedArray.getColor(R.styleable.TvPageVideoWidget_tvpw_load_more_button_background_color,
                getResources().getColor(R.color.default_load_more_bg_color));

        mLoadMoreBorderRadius = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_load_more_button_radius,
                getResources().getDimension(R.dimen.default_load_more_radius));

        mLoadMoreBorderWidth = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_load_more_button_border_width,
                getResources().getDimension(R.dimen.default_load_more_border_width));

        mLoadMoreBorderColor = typedArray.getColor(R.styleable.TvPageVideoWidget_tvpw_load_more_button_border_color,
                getResources().getColor(R.color.default_load_more_border_color));

    }

    /**
     * Set title text attribute set
     */
    private void setTitleTextAttributeSet(TypedArray typedArray) {
        String titleText = (String) typedArray.getText(R.styleable.TvPageVideoWidget_tvpw_video_title);
        if (CommonUtils.isValidString(titleText))
            mTitleTextString = titleText;

        mTitleTextBackgroundColor = typedArray.getColor(R.styleable.TvPageVideoWidget_tvpw_video_title_text_background_color,
                getResources().getColor(R.color.white));

        mTitleTextColor = typedArray.getColor(R.styleable.TvPageVideoWidget_tvpw_video_title_text_color,
                getResources().getColor(R.color.default_title_text_color));


        String gravity = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_video_title_text_gravity);
        if (CommonUtils.isValidString(gravity))
...
//            mTitleTextVisibility = visibility;
        ...
        String textStyle = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_video_title_text_style);
        if (CommonUtils.isValidString(textStyle))
            mTitleTextStyle = textStyle;

        String fontTypeFace = typedArray.getString(R.styleable.TvPageVideoWidget_tvpw_video_title_font_path);
        if (CommonUtils.isValidString(fontTypeFace))
            mTitleTextTypeFace = fontTypeFace;

        mTitleTextPadding = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_video_title_text_padding,
                getResources().getDimension(R.dimen.default_video_title_padding));

        float textSize = typedArray.getDimension(R.styleable.TvPageVideoWidget_tvpw_video_title_text_size,
...
//            b.putParcelableArrayList(Constants.BUNDLE_KEY_VIDEO_LIST, list);
            Log.d(TAG, "onItemClick: " + new Gson().toJson(list.get(position)));
     ...
     *
     * @param title(pass title text)
     */
    public void setTitleTextString(String title) {
        if (CommonUtils.isValidString(title)) {
            this.mTitleTextString = title;
            setVideoTitleStyle();
        }
    }
...
//    }
     ...
     *
     * @param color(pass load more text)
     */
    public void setLoadMoreTextColor(int color) {
        if (color != 0
                && String.valueOf(color).length() >= 6) {
            this.mLoadMoreTextColor = color;
            setLoadMoreButtonStyle();
        }
    }
    ...
    public void setLoadMoreBackgroundColor(int color) {
        if (color != 0
                && String.valueOf(color).length() >= 6) {
            this.mLoadMoreBackgroundColor = color;
            setLoadMoreButtonStyle();
        }
    }
     ...
     * @param color(pass resource color)
     */
    public void setLoadMoreBorderColor(int color) {
        if (color != 0
                && String.valueOf(color).length() >= 6) {
            this.mLoadMoreBorderColor = color;
            setLoadMoreButtonStyle();
        }
    }
     ...
     */
    public void setLoadMoreBorderRadius(float radius) {
        if (radius != 0) {
            this.mLoadMoreBorderRadius = radius;
            setLoadMoreButtonStyle();
        }
    }
     ...
     */
    public void setLoadMoreBorderWidth(float width) {
        if (width != 0) {
            this.mLoadMoreBorderWidth = width;
            setLoadMoreButtonStyle();
        }
    }
     ...
     * Set items per page
     *
     * @param perPageCount(pass item count)
     */
    public void setItemsPerPage(int perPageCount) {
        if (perPageCount != 0)
            this.mItemsPerPage = perPageCount;
    }

    /**
     * Set items per row count
     *
     * @param perRowCount(pass item count)
     */
    public void setItemsPerRow(int perRowCount) {
        if (perRowCount != 0) {
            this.mItemsPerRow = perRowCount;
        }
    }
     ...
     */
    public void setItemsTextSize(final float textSize) {
        this.mItemsTextSize = CommonUtils.getValidFloat(textSize,
                getResources().getDimension(R.dimen.default_items_title_text_size));
        if (adapter != null) {
            //To Update Ui From Main thread
            if (getActivity() != null) {
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        adapter.setItemsTextSize(CommonUtils.getValidFloat(textSize,
                                getResources().getDimension(R.dimen.default_items_title_text_size)));
     ...
     *
     * @param textStyle(Pass Enum value Enums.FONT_STYLE)
     */
    public void setItemsTextStyle(final Enums.FONT_STYLE textStyle) {
        this.mItemsTextStyle = CommonUtils.getTextStyle(textStyle);
        if (adapter != null) {
            ...
            if (getActivity() != null) {
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        adapter.setItemsTextStyle(CommonUtils.getTextStyle(textStyle));
                    }
                });
            }
        }
     ...
     * @param color(pass resource color)
     */
    public void setModalBorderWidth(float color) {
        this.mModalBorderWidth = color;
    }
     ...
     * @param fontStyle(pass Enums.FONT_STYLE value)
     */
    public void setProductReviewStyle(Enums.FONT_STYLE fontStyle) {
        this.mProductReviewStyle = CommonUtils.getTextStyle(fontStyle);
    }
